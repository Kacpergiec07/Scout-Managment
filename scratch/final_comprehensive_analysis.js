...
async function main() {
  console.log('='.repeat(100));
  console.log('COMPREHENSIVE TEAM ANALYSIS (All Top Teams - Correct IDs)');
  console.log('='.repeat(100));
  console.log('');
  ...
  const teamsToTest = [
    ...
    { name: 'Manchester United', teamId: '7', seasonId: '515' },
    { name: 'Borussia Dortmund', teamId: '42', seasonId: '521' },
